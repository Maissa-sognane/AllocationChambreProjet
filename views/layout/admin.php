...
<div class="container-fluid">
    <div class="row" style="height: auto">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="list-group"  id="list-tab" role="tablist">
                        <a class="list-group-item p-lg-5 list-group-item-action " href="<?=BASE_URL?>/admin/createEtudiant" >
                            <i class="fas fa-user-plus"><span> Ajouter Etudiant</span></i>
                        </a>
                        <a class="list-group-item p-lg-5 list-group-item-action"   href="<?=BASE_URL?>/admin/createChambre" >
                            <i class="fas fa-plus-square"><span> Ajouter Chambre</span></i>
                        </a>
                        <a class="list-group-item p-lg-5 list-group-item-action"   href="<?=BASE_URL?>/admin/ListeEtudiant" role="tab" aria-controls="messages">
                            <i class="fas fa-users"> <span>Les Etudiants</span></i>
                        </a>
                        <a class="list-group-item p-lg-5 list-group-item-action"   href="<?=BASE_URL?>/admin/ListeChambre" role="tab" aria-controls="settings">
        ...
        <div class="col-8" style="background-color: #E5E5E5">
